    ...
    <footer className="w-full bg-slate-900 text-slate-300 mt-16">
      ...
      <div className="border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 py-6 text-sm text-slate-500 flex items-center justify-between">
          ...
          <span>Made by <a target="_blank" href="https://github.com/mustafakaracuha" className="text-lime-500 hover:text-lime-600 transition-colors">MUSTAFA KARAÇUHA</a></span>
        </div>
      </div>
    </footer>
  )
